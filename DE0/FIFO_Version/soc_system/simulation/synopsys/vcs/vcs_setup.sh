...
# ACDS 19.1 670 win32 2022.05.06.10:36:10
...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/soc_system_opal_kelly_pio.v \
  ...
  $QSYS_SIMDIR/submodules/soc_system_fake_OK.v \
  $QSYS_SIMDIR/submodules/soc_system_dac_pio.v \
  $QSYS_SIMDIR/submodules/soc_system_busy_in.v \
