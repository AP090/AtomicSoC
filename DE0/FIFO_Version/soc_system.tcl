...
# File: soc_system.tcl
# Generated on: Fri May 06 11:01:09 2022
...
if {$make_assignments} {
	...
	set_global_assignment -name SEARCH_PATH "c:\\users\\alan\\desktop\\soc system de-0 compiled edition 18 - copy\\soc\\fifo_version\\soc_system\\synthesis\\submodules"
	set_global_assignment -name VHDL_FILE writeSideDriver.vhd
	set_global_assignment -name VHDL_FILE readSideDriver.vhd
	set_global_assignment -name VHDL_FILE AD5791_SPI_Driver_2.vhd
	...
	set_global_assignment -name SIP_FILE DACpll1.sip
	set_global_assignment -name QIP_FILE newpll.qip
	set_global_assignment -name SIP_FILE newpll.sip
	set_global_assignment -name VHDL_FILE sync_2ff.vhd
	set_global_assignment -name VHDL_FILE clock_OR.vhd
