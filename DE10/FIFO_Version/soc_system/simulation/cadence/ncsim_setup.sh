...
# ACDS 21.1 842 win32 2022.02.04.15:03:53
...
mkdir -p ./libraries/opal_kelly_pio/
...
mkdir -p ./libraries/fake_OK/
mkdir -p ./libraries/dac_pio/
mkdir -p ./libraries/busy_in/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0_avalon_st_adapter_001.vhd"                -work avalon_st_adapter_001                                            -cdslib ./cds_libs/avalon_st_adapter_001.cds.lib                                           
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_opal_kelly_pio.vhd"                                         -work opal_kelly_pio                                                   -cdslib ./cds_libs/opal_kelly_pio.cds.lib                                                  
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_fake_OK.vhd"                                                -work fake_OK                                                          -cdslib ./cds_libs/fake_OK.cds.lib                                                         
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_dac_pio.vhd"                                                -work dac_pio                                                          -cdslib ./cds_libs/dac_pio.cds.lib                                                         
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/soc_system_busy_in.vhd"                                                -work busy_in                                                          -cdslib ./cds_libs/busy_in.cds.lib                                                         
