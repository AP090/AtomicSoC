	soc_system u0 (
		.busy_in_external_connection_export        (<connected-to-busy_in_external_connection_export>),        //        busy_in_external_connection.export
		.clk_clk                                   (<connected-to-clk_clk>),                                   //                                clk.clk
		.dac_pio_external_connection_export        (<connected-to-dac_pio_external_connection_export>),        //        dac_pio_external_connection.export
		.fake_ok_external_connection_export        (<connected-to-fake_ok_external_connection_export>),        //        fake_ok_external_connection.export
		.fifo_wrfull_external_connection_export    (<connected-to-fifo_wrfull_external_connection_export>),    //    fifo_wrfull_external_connection.export
		...
		.new_word_ready_external_connection_export (<connected-to-new_word_ready_external_connection_export>), // new_word_ready_external_connection.export
		.opal_kelly_pio_external_connection_export (<connected-to-opal_kelly_pio_external_connection_export>), // opal_kelly_pio_external_connection.export
		.reset_reset_n                             (<connected-to-reset_reset_n>),                             //                              reset.reset_n
		.system_reset_external_connection_export   (<connected-to-system_reset_external_connection_export>)    //   system_reset_external_connection.export
	);
